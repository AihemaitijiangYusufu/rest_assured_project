...
public class DatabaseUtility {
    ...
    public static void createConnection() {
        String url ="jdbc:postgresql://room-reservation-qa.cxvqfpt4mc2y.us-east-1.rds.amazonaws.com/room_reservation_qa?:5432";
        String user = "qa_user";
    ...
    public static int getRowCount(String sql) throws SQLException,ClassNotFoundException {
